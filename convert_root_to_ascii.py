...
write_histo_contents(xs_gg_H,     './data/ascii/xs_gg_H.dat')
write_histo_contents(br_H_hh,     './data/ascii/br_H_hh.dat')
write_histo_contents(br_h_tautau, './data/ascii/br_h_tautau.dat')
write_histo_contents(br_h_bb,     './data/ascii/br_h_bb.dat')
write_histo_contents(br_h_gamgam, './data/ascii/br_h_gamgam.dat')
write_histo_contents(m_H,         './data/ascii/m_H.dat')
write_histo_contents(Gamma_H,     './data/ascii/Gamma_H.dat')

save_binning(xs_gg_H, './data/ascii/xs_gg_H_binning.dat')
save_binning(br_H_hh, './data/ascii/br_H_hh_binning.dat')
save_binning(br_h_tautau, './data/ascii/br_h_tautau_binning.dat')
